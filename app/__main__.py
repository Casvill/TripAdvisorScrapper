...
driver = extract.driver_connection()
# restaurant info
for i in range(30*cities):
    ...
    df_restaurants_info = transform.transform_restaurants_info(extract.extract_restaurant_info(href, driver), restaurant, city, state)
    time.sleep(1)
